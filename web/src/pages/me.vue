<script setup lang="ts">
  ...
  let name = ref(`${authStore.getUser.firstName} ${authStore.getUser.lastName}`)
...
<template>
  <BaseLayout>
    <div
      class="flex-1 flex mb:flex-col items-start mb:items-center gap-6 min-h-full"
    >
      <div class="h-full w-[375px] p-6 flex flex-col items-center gap-2">
        ...
        <div class="flex flex-col gap-2 w-full">
          <header role="radiogroup" class="flex gap-12 justify-center">
            <label
              class="flex-none"
              :class="
                selectedTab === 'info' ? 'text-zinc-800' : 'text-zinc-400'
              "
            >
              Infos
            ...
            <label
              class="flex-none"
              :class="
                selectedTab === 'password' ? 'text-zinc-800' : 'text-zinc-400'
              "
            >
              Change password
          ...
          <form class="w-full flex flex-col gap-2">
            ...
            >
              <label
                class="flex items-center h-[3.5rem] gap-[2px] bg-white focus-within:ring-[2px] focus-within:ring-zinc-400"
              >
                <div class="p-4">
                  <PhUser weight="bold" />
                </div>
              ...
              >
                ...
                <div class="flex-1 flex flex-col text-left">
                  <span class="text-zinc-400 text-sm"> E-mail </span>
                  <input
                    class="w-full outline-0 text-zinc-500"
                    v-model="email"
                  />
              ...
              >
                ...
                <div class="flex-1 flex flex-col text-left">
                  <span class="text-zinc-400 text-sm"> CNH </span>
                  <input
                    type="number"
                    class="w-full outline-0 text-zinc-500"
                    v-model="cnh"
      ...
      <div class="flex-1 flex flex-col justify-start gap-5 px-6 pt-6 mb:pb-20">
        <h1 class="text-2xl text-left font-semibold">My rents</h1>
