    ...
    <div class="bg-white flex items-center justify-center p-4">
      <div class="flex flex-col w-[40%] gap-5">
        ...
        <div class="w-full flex items-center justify-between">
          ...
          <PhDrop class="text-2xl text-zinc-400" weight="bold" />
        </div>
      </div>

      <div class="flex-1 flex items-center justify-center">
        <img :src="car.thumbs[0]" class="w-[80%]" alt="" />
      </div>
    </div>

    <div class="flex items-center justify-between bg-white p-4">
      <span class="text-zinc-400 text-sm"> RENTAL PERIOD </span>
      ...
      <div class="flex w-[60%] items-center justify-around">
        ...
        <PhArrowRight class="text-2xl text-zinc-600" weight="bold" />
