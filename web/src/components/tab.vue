...
<template>
  <header
	...
	>
	  <label
		  class="p-2 text-md relative"
			:class="selectedTab === 'car' ? 'text-zinc-700 font-bold after:content-[\'\'] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px] after:bg-red-500' : 'text-zinc-400'"
		>
		  <p>ABOUT THE CAR</p>
			<input
			  type="radio"
		...
		<label
		  class="p-2 text-md relative"
			:class="selectedTab === 'period' ? 'text-zinc-700 font-bold after:content-[\'\'] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px] after:bg-red-500' : 'text-zinc-400'"
		>
		  <p>PERIOD</p>
			<input
			  type="radio"
	...
	<div
	  v-if="selectedTab === 'car'"
	  class="w-full min-h-[150px] py-4"
	>
	...
	>
	  <div class="w-full flex gap-4 items-center justify-start">
  	  <p class="text-left text-sm text-zinc-400">
			...
			<button class="bg-red-500 p-2 flex items-center justify-center text-white ml-auto">
			  <PhCalendar
				  size="20"
					weight="bold"
				/>
