...
export class relations1666793690499 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_customers" ("id" varchar PRIMARY KEY NOT NULL, "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, "password" varchar NOT NULL, "email" varchar NOT NULL, "cnh" integer NOT NULL, "avatar" varchar, CONSTRAINT "UQ_5329dc7dc26e74ccb3b0cf54051" UNIQUE ("cnh"), CONSTRAINT "UQ_8536b8b85c06969f84f0c098b03" UNIQUE ("email"))`);
        await queryRunner.query(`INSERT INTO "temporary_customers"("id", "firstName", "lastName", "password", "email", "cnh", "avatar") SELECT "id", "firstName", "lastName", "password", "email", "cnh", "avatar" FROM "customers"`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_rents"("id", "startRent", "endRent") SELECT "id", "startRent", "endRent" FROM "rents"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "customers" ("id" varchar PRIMARY KEY NOT NULL, "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, "password" varchar NOT NULL, "email" varchar NOT NULL, "cnh" integer NOT NULL, "avatar" varchar, CONSTRAINT "UQ_5329dc7dc26e74ccb3b0cf54051" UNIQUE ("cnh"), CONSTRAINT "UQ_8536b8b85c06969f84f0c098b03" UNIQUE ("email"))`);
        await queryRunner.query(`INSERT INTO "customers"("id", "firstName", "lastName", "password", "email", "cnh", "avatar") SELECT "id", "firstName", "lastName", "password", "email", "cnh", "avatar" FROM "temporary_customers"`);
        await queryRunner.query(`DROP TABLE "temporary_customers"`);
        await queryRunner.query(`ALTER TABLE "rents" RENAME TO "temporary_rents"`);
        await queryRunner.query(`CREATE TABLE "rents" ("id" varchar PRIMARY KEY NOT NULL, "startRent" timestamp NOT NULL, "endRent" timestamp NOT NULL)`);
        await queryRunner.query(`INSERT INTO "rents"("id", "startRent", "endRent") SELECT "id", "startRent", "endRent" FROM "temporary_rents"`);
        await queryRunner.query(`DROP TABLE "temporary_rents"`);
        await queryRunner.query(`ALTER TABLE "customers" RENAME TO "temporary_customers"`);
        await queryRunner.query(`CREATE TABLE "customers" ("id" varchar PRIMARY KEY NOT NULL, "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, "password" varchar NOT NULL, "email" varchar NOT NULL, "cnh" integer NOT NULL, "avatar" varchar, CONSTRAINT "UQ_5329dc7dc26e74ccb3b0cf54051" UNIQUE ("cnh"), CONSTRAINT "UQ_8536b8b85c06969f84f0c098b03" UNIQUE ("email"))`);
        await queryRunner.query(`INSERT INTO "customers"("id", "firstName", "lastName", "password", "email", "cnh", "avatar") SELECT "id", "firstName", "lastName", "password", "email", "cnh", "avatar" FROM "temporary_customers"`);
